...
import type * as Helpers from "../internal/index.ts";
import type { Std } from "../std/index.ts";
import type { Tuples } from "../tuples/index.ts";
import type * as Impl from "./internal/index.ts";
...
export namespace Strings {
	...
	export interface SnakeCase extends Fn {
		return: Helpers.SnakeCase<this["arg0"]>;
	}
	...
	export interface CamelCase extends Fn {
		return: Helpers.CamelCase<this["arg0"]>;
	}
	...
	export interface KebabCase extends Fn {
		return: Helpers.KebabCase<this["arg0"]>;
	}
