import type { Call, Fn, PartialApply, _, unset } from "../core/index.ts";
import type { IsArrayStrict, Prettify } from "../internal/index.ts";
import type { Std } from "../std/index.ts";
import type { Strings } from "../strings/index.ts";
import type * as Impl from "./internal/index.js";
