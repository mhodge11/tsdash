[@tsdash/decorator](README.md) / Exports
...
- [decDebounce](modules.md#decdebounce)
- [decMaxCalls](modules.md#decmaxcalls)
- [decMemoize](modules.md#decmemoize)
- [decMinCalls](modules.md#decmincalls)
- [decThrottle](modules.md#decthrottle)
- [toDecorator](modules.md#todecorator)
...
[decorator/src/decDebounce.ts:30](https://github.com/mhodge11/tsdash/blob/d8fd390/packages/decorator/src/decDebounce.ts#L30)
...
[decorator/src/decMaxCalls.ts:33](https://github.com/mhodge11/tsdash/blob/d8fd390/packages/decorator/src/decMaxCalls.ts#L33)
...
[decorator/src/decMemoize.ts:39](https://github.com/mhodge11/tsdash/blob/d8fd390/packages/decorator/src/decMemoize.ts#L39)
...
[decorator/src/decMinCalls.ts:30](https://github.com/mhodge11/tsdash/blob/d8fd390/packages/decorator/src/decMinCalls.ts#L30)
...
[decorator/src/decThrottle.ts:29](https://github.com/mhodge11/tsdash/blob/d8fd390/packages/decorator/src/decThrottle.ts#L29)

___

### toDecorator

▸ **toDecorator**\<`T`\>(`func`): (...`args`: `Tail`\<`Parameters`\<`T`\>\>) => (`_target`: `unknown`, `_key`: `string`, `descriptor`: `PropertyDescriptor`) => `void`
...
[decorator/src/toDecorator.ts:34](https://github.com/mhodge11/tsdash/blob/d8fd390/packages/decorator/src/toDecorator.ts#L34)
